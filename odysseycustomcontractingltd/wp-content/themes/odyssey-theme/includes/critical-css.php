...
add_action( 'wp_head', function () {
  ...
  if ( file_exists( $critical_file ) ) {
    ...
    echo '<style id="ody-critical-css">' . $critical_css . '</style>' . "\n";
  }
 ...
 * Targets the main style and any page-specific styles (starting with ody-).
 */
  ...
  // Targets theme-custom-style AND any page-specific handles like ody-contact-style
  $is_target = ( $handle === 'theme-custom-style' || strpos( $handle, 'ody-' ) === 0 );
