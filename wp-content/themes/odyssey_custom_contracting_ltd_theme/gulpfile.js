...
gulp.task('scripts', function() {
	var scripts = [
		...
		`${paths.dev}/js/simple-lightbox.js`,
...
gulp.task('copy-assets', function(done) {
	...
	// Copy all Simple Lightbox gallery SCSS files
	gulp
		.src(`${paths.node}simplelightbox/src/*.scss`)
		.pipe(gulp.dest(`${paths.dev}/sass`));

	// Copy all Simple Lightbox gallery JS files
	gulp
		.src(`${paths.node}simplelightbox/dist/simple-lightbox.js`)
...
//Run:
// gulp compile-prod
// compiles the styles and scripts and runs the dist-production task
gulp.task('compile-prod', gulp.series('styles','scripts', 'dist-product'));

// Run:
// gulp
// Starts watcher (default task)
gulp.task('default', gulp.series('compile','watch-bs'));
