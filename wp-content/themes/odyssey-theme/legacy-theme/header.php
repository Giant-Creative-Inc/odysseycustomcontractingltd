...
<head>
	<?php include LEGACY_THEME_DIR . '/inc/analytics.php'; ?>

	<meta charset="<?php bloginfo('charset'); ?>">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<meta name="google-site-verification" content="PpqgjAcpPwdENngS9nDxGPcOAeSLg1r37Qs9jmJkSkk" />
	<link rel="profile" href="http://gmpg.org/xfn/11">
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo esc_url(LEGACY_THEME_URI); ?>/apple-touch-icon.png">
	<link rel="icon" type="image/png" href="<?php echo esc_url(LEGACY_THEME_URI); ?>/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="<?php echo esc_url(LEGACY_THEME_URI); ?>/favicon-16x16.png" sizes="16x16">
	<link rel="manifest" href="<?php echo esc_url(LEGACY_THEME_URI); ?>/site.webmanifest">
	<link rel="mask-icon" href="<?php echo esc_url(LEGACY_THEME_URI); ?>/safari-pinned-tab.svg" color="#1C1818">
	<link rel="shortcut icon" href="<?php echo esc_url(LEGACY_THEME_URI); ?>/favicon.ico">
	<meta name="msapplication-config" content="<?php echo esc_url(LEGACY_THEME_URI); ?>/browserconfig.xml">
